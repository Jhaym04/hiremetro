  ...
  <div id="myCarousel" class=" container carousel slide" data-ride="carousel">
    ...
    <!--intro-->
      <div class="row">
        <div class="col-lg-6">
          <img class="img-fluid rounded mb-4" src="images/i1.jpg" alt="">
        </div>
        <div class="col-lg-6">
      ...
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card h-100 text-center">
            <img class="card-img-top" src="images/jm.jpeg" alt="" style="border-radius: 50%;width: 80%;"">
            <div class="card-body">
              <h4 class="card-title lead">John Mher Emotin</h4>
              <h6 class="card-subtitle mb-2 text-muted">Leader</h6>
              <p class="card-text"> A 3rd Year Student taking up Bachelor of Science in Information Technology at Technological University of the Philippines,Manila | Navotas Metro Manila
            </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100 text-center">
            <img class="card-img-top" src="images/czar.jpeg" alt=" Jhon Emotin" style="border-radius: 50%;width: 80%;"">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100 text-center">
            <img class="card-img-top" src="images/cel.jpeg" alt="Celine Macaraeg" style="border-radius: 50%;width: 80%;""">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100 text-center">
            <img class="card-img-top" src="images/navs.jpeg" alt="Christian Navarro" style="border-radius: 50%;width: 80%;"">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100 text-center">
            <img class="card-img-top" src="images/lei.jpeg" alt="Lei Dian" style="border-radius: 50%;width: 80%;"">
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100 text-center">  
            <img class="card-img-top" src="images/mar.jpeg" alt="Elvin Marin" style="border-radius: 50%;  width: 80%;"  >
            <div class="card-body">
