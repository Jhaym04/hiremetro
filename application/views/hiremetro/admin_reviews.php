				  ...
				  <ul class="nav nav-sidebar">
					...
					<div class="collapse navbar-collapse" id="myNavbar2">
						<ul class="nav nav-sidebar" id="navbuttons" style="background-color:#3b8686">
							...
							<li class="active" ><a href="<?php echo base_url('hiremetro/admin_reviews')?>"><span class="glyphicon glyphicon-book"> Reviews </a></li>
				...
				<div class="col-md-10">
					...
					<div class="row" id="padd">	
						<div class="well">
							<div class="row" >
								<div class="col-md-9">
									<h4><span class="glyphicon glyphicon-envelope">  </h4>
								</div>
