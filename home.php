				...
				<div class="modal-content" id="soMod">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-5 text-center" id="b2">
								<a href=""><img src="<?php echo base_url('images/b4.png'); ?>" /></a>
							</div>
						</div>
					</div>
					<div class="modal-footer text-center">
	...
	<div class="container-fluid pagee" style="background-image: url('images/bg.png'); min-height: 50%; background-attachment: fixed; background-position: center; background-repeat: no-repeat; background-size: cover; ">
		...
		<div class="row" id="footer">
			...
			<div class="col-lg-2">
				...
				<a data-toggle="modal" data-target="#specialoffersModal" style="margin-right: 20px; cursor: pointer;">Special Offer</a>
				<br /><a>Discount</a>
				<br /><a>Freebies</a>
				<br />
			</div>
