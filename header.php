...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('css/freebies.css')?>">
...
<body>
	...
	<!-- Modal for signup 2-->
		...
		<!-- Modal for freebies-->
		<div class="modal fade" id="freebiesModal" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content" id="soMod">
					<div class="modal-header text-center" id="soHeader">
						<button type="button" class="close" data-dismiss="modal"> &times; </button>
						<h4 class="modal-title"> FREEBIES </h4>
						<p>enjoy our offers wit freebies</p>
					</div>
					<div class="modal-body" id="termsofserv">
						<div class="row">
							<div class="col-md-5 text-center">
								<img src="<?php echo base_url('images/keychain.png'); ?>" />
							</div>
							<div class="col-md-7 text-left">
								<h4> Free Keychain </h4>
								<p>Receive our free keychain for <b>every employee you hire for a day!</b> What are you waiting for? Hire now!</p>
							</div>
						</div>
						<div class="row">
							<div class="col-md-7 text-left">
									<h4><br /> Free T-Shirt </h4>
									<p>Receive our free T-Shirt for <b>every employee you hire for 3 days!</b> What are you waiting for? Hire now!</p>
							</div>
							<div class="col-md-5 text-center">
								<img src="<?php echo base_url('images/shirt.png'); ?>" />
							</div>
						</div>
					</div>
					<div class="modal-footer text-center">
