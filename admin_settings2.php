							...
							<div  class="table-responsive">          
								  <table class="table table-bordered text-center" >
									...
									<tbody>
									  <tr>
										<td>Sample</td>
										<td><a data-toggle="modal" data-target="#updateModal" style="cursor: pointer;">Update</a> | <a href="#">Delete</a></td>	
									  </tr>
			...
			<div class="modal-dialog">
				<div class="modal-content" id="login">
					<div class="modal-header text-center" id="header">
						...
						<p>change your your username and/or password</p>
					</div>
					<div class="modal-body">
						<form action="<?php echo base_url('hiremetro/login')?>" method="post">
							<div class="form-vertical">
								...
								<div class="form-group">
									<input type="text" class="form-control" name="newusername2" placeholder="Confirm username"> 
								</div>
								<br />
								<div class="form-group">
								...
								<div class="form-group">
									<input type="password" class="form-control" name="newpassword2" placeholder="Confirm Password"> 
								</div>
								<br />
								<div>
									<p>To confirm changes, input your old username and password</p>
								</div>
								<div class="form-group">
